...
t.match(y, z, 'build from single list or args')
...
t.match(Yallist(y.toArray()), y)
t.match(Yallist.apply(null, y.toArray()), y)
...
t.test('slice', function (t) {
  ...
  cases.forEach(function (c) {
    t.test(JSON.stringify(c), function (t) {
      t.match(a.slice.apply(a, c[0]), Yallist(c[1]))
...
t.test('sliceReverse', function (t) {
  ...
  cases.forEach(function (c) {
    ...
    t.test(JSON.stringify([c[0], rev]), function (t) {
      t.match(a.sliceReverse.apply(a, c[0]), Yallist(rev))
